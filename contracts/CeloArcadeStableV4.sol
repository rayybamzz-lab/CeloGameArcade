...
contract CeloArcadeStableV4 {
    ...
    // Kept for backward compatibility with existing frontend ABIs.
    IERC20 public immutable usdmToken;
    uint8 public immutable tokenDecimals;

    uint256 private immutable _minEntryFee;
    uint256 private immutable _maxEntryFee;
    ...
    // Mutable entry fee in token base units.
