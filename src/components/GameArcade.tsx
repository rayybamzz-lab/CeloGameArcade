...
export default function GameArcade() {
  ...
  // DIFFICULTY MODAL
  const Modal = () => (
    <div role="dialog" style={{ position: 'fixed', inset: 0, background: 'rgba(0,0,0,0.9)', backdropFilter: 'blur(10px)', zIndex: 100, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '14px' }}>
